...
abstract class BluetoothService(connection: BluetoothSocket, protected val securityConnection: SignatureConnectionHandler) {
    protected val inputStream: DataInputStream = DataInputStream(connection.inputStream)
    private val outputStream: DataOutputStream = DataOutputStream(connection.outputStream)
